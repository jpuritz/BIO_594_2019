...
f(BIO594) [evelyn-takyi@n007 BIO594]$ for i in ${array1[@]}
> do
...
(BIO594) [evelyn-takyi@n007 BIO594]$ for i in ${array1[@]}
> do
...
### Generate histogram to visualise basic features of the quality filteredfiles.
...
> echo "${i}"
> done
#### Run StringTie merge, merge transcripts from all samples
...
#### Compare how transcripts compare to reference annotation using gffcompare
...
[evelyn-takyi@n040 BIO594]$ less transcript_count_matrix.csv
add few lines

#### The differential gene expression is carried in R using Deseq.
File in folder known as DeseqA
